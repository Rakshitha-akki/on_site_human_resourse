            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                       <!--<form id="contact" action="addmanager.php" method="post" name="addmanager" onsubmit="return validate();">
                          <div class="row">
                            <div class="col-lg-12">
                                <h4>Add Manager</h4>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="name" type="text" id="name" maxlength="20" minlength="3" placeholder="Your Name*" required="">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="phone" type="text" id="phone" maxlength="10" minlength="10" placeholder="Phone Number*" required="">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="confirmpassword" type="password" id="confirmpassword" placeholder="confirmpassword" required="">
                              </fieldset>
                            </div>
