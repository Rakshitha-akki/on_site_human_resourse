   ...
   <style>
    ...
    <?php
        ...
        <h3 style='border-radius:25px;
                    ...
                    text-align:center;
                    margin-left:300px;
                    margin-right:300px;'>project details</h3>
        <?php
        ...
        if($len>0)
        {
            ...
            for($i=0;$i<$len;$i++)
            {
                ...
                echo "<tr>";
                echo "<td style='text-align:center'><a href=selectlabour.php?projectid=$a&projectname=$b&place=$c&engineer=$d&startdate=$e&enddate=$f&estimation=$g>$a</a></td>";
